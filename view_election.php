        ...
        <?php foreach ($candidates as $candidate): ?>
          <div class="bg-white border shadow-lg p-6 transition-all duration-300">
            <div class="flex flex-col items-center">
              <img src="<?= htmlspecialchars($candidate['photo_url']) ?: 'default-avatar.png' ?>"
                   onerror="this.onerror=null;this.src='default-avatar.png';"
                   class="w-32 h-32 object-cover border rounded-full shadow mb-4">
            ...
            <div class="mt-4 flex justify-center gap-3">
              <button onclick='openEditModal(<?= json_encode($candidate) ?>)'
  ...
  <div class="bg-white w-full max-w-lg p-6 shadow-lg">
    ...
    <form method="POST" action="edit_candidate.php" enctype="multipart/form-data">
      ...
      <div class="mb-4">
        ...
        <input type="file" name="photo" id="editPhotoInput" accept="image/*" class="w-full border px-3 py-2 mt-1">
        <div class="mt-3 text-center">
          <img id="photoPreview" src="default-avatar.png" class="w-24 h-24 object-cover border rounded-full mx-auto">
        </div>
      </div>
...
function openEditModal(candidate) {
  ...
  document.getElementById('photoPreview').src = candidate.photo_url || 'default-avatar.png';
